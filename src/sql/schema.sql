...
INSERT INTO users (login,email,passhash) VALUES ('admin', 'admin@mail.com', 'admin');
INSERT INTO users (login,email,passhash) VALUES ('tester', 'tester@mail.com', 'tester');
INSERT INTO users (login,email,passhash) VALUES ('user', 'user@mail.com', 'user');
INSERT INTO users (login,email,passhash) VALUES ('<h1>hacker</h1>', 'hacker@mail.ru', 'hacker');
