 ...
 *
 * <Resource name="jdbc/dataSource3" auth="Container" type="javax.sql.DataSource" driverClassName="org.h2.Driver"
...
public class ConnectionManager {
	...
	private ConnectionManager() {
		try {
	        ...
	        dataSource = (DataSource) xmlContext.lookup("jdbc/dataSource3");
